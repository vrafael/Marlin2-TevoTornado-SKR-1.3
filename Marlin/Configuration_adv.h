...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 1520   // Maximum interval between clicks, in milliseconds.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       40  // (mm) Unload initial retract length.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1100 //RAV 1100        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       1250 //RAV 1100
